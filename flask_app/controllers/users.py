...
def profile(id):
    ...
    total = Magazine.calculate_total_subscriptions(subscriptions, number)
    return render_template("profile.html",user=user,subscriptions=subscriptions,total=total)
